...
{
    public  class TestSendEmailFunction
    {
        ...
        public TestSendEmailFunction(IConfiguration configuration)
        {
            ...
            FunctionContext executionContext)
        {
            ...
            */
            ...
            sendMailModel.Subject = "SubjectSubject";
            sendMailModel.Content = "<h1>My First Heading</h1>";
            //
